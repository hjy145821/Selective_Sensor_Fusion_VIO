...
def test(args, test_loader, feature_ext, rec_feat, rec_imu, pose_net,
    ...
    for i, (imgs, imus, poses) in enumerate(test_loader):
        ...
        file_name = r'E:\SLAM\results\all_degradation\direct\result_seq' + str(k) + '_' + str(epoch) + '.csv'
        np.savetxt(file_name, result, delimiter=',')

        file_name = r'E:\SLAM\results\all_degradation\direct\truth_pose_seq' + str(k) + '_' + str(epoch) + '.csv'
        np.savetxt(file_name, truth_pose, delimiter=',')

        file_name = r'E:\SLAM\results\all_degradation\direct\truth_euler_seq' + str(k) + '_' + str(epoch) + '.csv'
